...
export function helpSections(v = {}) {
        ...
        blocks: [
          { k:"steps",
            ...
            en:[
              ...
              "Write an update in the notes box and hit ADD. That is the action you will repeat most.",
        ...
        blocks: [
          ...
          { k:"kv",
            rows:[
              ...
              [{es:"APG Realty",en:"APG Realty"},{es:"Socia referidora, no es de la sucursal · split completo",en:"A referral partner, not branch staff · full split"}],
            ] },
          { k:"p",
...

      {
        ...
        blocks: [
          { k:"p",
            ...
            en:"Open any of your files and scroll to the green block, YOUR COMPENSATION ON THIS FILE. The full chain is there." },
          { k:"list",
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    articles: [
      ...
      {
        id: "puertas",
        es: "Las ocho puertas", en: "The eight gates",
        blocks: [
          { k:"lead",
            es:"Ocho reglas, en cinco etapas, donde el sistema no te deja salir sin el dato que debía capturarse ahí.",
            en:"Eight rules, across five stages, where the system will not let you leave without the data that had to be captured there." },
          { k:"p",
        ...
        blocks: [
          ...
          { k:"table",
            ...
            rows:[
              ...
              ["3 · Processing", {es:"Asistente · Procesador",en:"Assistant · Processor"}, {es:"Full Application: captura las cinco fechas de contingencia y registra con el lender, 48 horas desde el 1003 completo. Después Initial Disclosures, y las órdenes pasan al Procesador.",en:"Full Application: capture the five contingency dates and register with the lender, 48 hours from a complete 1003. Then Initial Disclosures, and the orders go to the Processor."}],
          ...
          { k:"kv",
            rows:[
              ...
              [{es:"Procesador",en:"Processor"},
               {es:"Trabaja desde Processing: título, tasación, seguro, sumisión y verificaciones finales. Ve el pipeline completo y, de producción, el scorecard, la mezcla y las tareas vencidas. No ve compensación.",
                en:"Works from Processing: title, appraisal, insurance, submission and final verifications. Sees the whole pipeline and, of production, the scorecard, the mix and the overdue tasks. Does not see compensation."}],
        ...
        blocks: [
          ...
          { k:"table",
            ...
            rows:[
              ...
              ["Production · Mix","·","·","·","·"],
              [{es:"Production · Tareas vencidas",en:"Production · Overdue tasks"},"·","·","·","·"],
              ["Production · Team, Monthly, Referrals","·","·","—","—"],
              ["Production · Bank Referrals","·","·","—","—"],
              ["Production · My Comp","·","·","—","—"],
        ...
        blocks: [
          { k:"kv",
            rows:[
              ...
              ["PTA / PTC / PTF",{es:"Los tres momentos de un documento: antes de la aprobación, antes del cierre, antes de fondear.",en:"The three moments of a document: prior to approval, prior to closing, prior to funding."}],
