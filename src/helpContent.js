          ...
          { k:"kv",
            rows:[
              ...
              [{es:"Asistente",en:"Assistant"},
               {es:"Ve y edita archivos, registra con el lender y verifica el 1003. Trabaja desde Processing, donde vive su cola. No ve compensación.",
                en:"Views and edits files, registers with the lender and verifies the 1003. Works from Processing, where their queue lives. Does not see compensation."}],
