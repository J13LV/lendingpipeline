...
export const UI = {
  ...
  gate1Yours: { es:"es tuyo · toca para marcar", en:"yours · tap to mark" },

  // ─── el CD ───
  cdTitle:    { es:"CLOSING DISCLOSURE", en:"CLOSING DISCLOSURE" },
  cdLead:     { es:"Lo emite el lender. Aquí se confirma cuándo salió — desde esa fecha corren los tres días hábiles de ley.",
                en:"The lender issues it. Here you confirm when it went out — the three statutory business days run from that date." },
  cdSent:     { es:"SALIÓ EL", en:"SENT ON" },
  cdHow:      { es:"CÓMO SE ENTREGÓ", en:"HOW IT WAS DELIVERED" },
  cdElec:     { es:"Electrónico", en:"Electronic" },
  cdMail:     { es:"Correo postal", en:"Mail" },
  cdElecNote: { es:"Con confirmación de recibo: recibe el mismo día.",
                en:"With confirmed receipt: received the same day." },
  cdMailNote: { es:"La ley presume el recibo tres días hábiles después de mandarlo.",
                en:"The law presumes receipt three business days after sending." },
  cdReceived: { es:"RECIBIDO", en:"RECEIVED" },
  cdEarliest: { es:"No se puede firmar antes del {d}", en:"Cannot sign before {d}" },
  cdTooEarly: { es:"La firma está el {f} y no se puede firmar antes del {d}. Este cierre rompe el plazo de la Regulación Z.",
                en:"Signing is set for {f} and it cannot happen before {d}. This closing breaks the Regulation Z waiting period." },
  cdFees:     { es:"FEES REVISADOS", en:"FEES REVIEWED" },
  cdFeesNote: { es:"Solo el LO. Un CD que salió y cuyos fees nadie miró es el archivo que revienta el día de la firma.",
                en:"LO only. A CD that went out with nobody checking the fees is the file that blows up at signing." },
  cdFeesBy:   { es:"revisados {d} · {who}", en:"reviewed {d} · {who}" },
  cdFeesMark: { es:"MARCAR REVISADOS", en:"MARK REVIEWED" },
  cdFeesWait: { es:"Lo marca el LO de este archivo.", en:"The file's LO marks this." },

  // ─── cartas ───
  ltTitle:    { es:"✉ CARTAS", en:"✉ LETTERS" },
  ltLead:     { es:"El sistema no redacta la explicación — esa la escribe el cliente con sus palabras, y una carta de plantilla el underwriter la rechaza. Lo que sí escribe es la petición.",
                en:"The system does not write the explanation — the client writes that in their own words, and a template letter gets rejected by underwriting. What it does write is the request." },
  ltNone:     { es:"Ninguna carta abierta en este archivo.", en:"No open letters on this file." },
  ltAdd:      { es:"+ LEVANTAR UNA CARTA", en:"+ RAISE A LETTER" },
  ltKind:     { es:"QUÉ CARTA", en:"WHICH LETTER" },
  ltWhat:     { es:"QUÉ HAY QUE EXPLICAR", en:"WHAT MUST BE EXPLAINED" },
  ltWhatPh:   { es:"por qué estuviste cuatro meses sin trabajo entre marzo y julio",
                en:"why you were out of work for four months between March and July" },
  ltFrom:     { es:"SE LE PIDE A", en:"ASKED OF" },
  ltSave:     { es:"GUARDAR", en:"SAVE" },
  ltNeedText: { es:"Escribe qué hay que explicar. Sin eso, el cliente no sabe qué mandar.",
                en:"Write what must be explained. Without it, the client does not know what to send." },
  ltRaised:   { es:"levantada", en:"raised" },
  ltRequested:{ es:"pedida", en:"requested" },
  ltReceived: { es:"recibida", en:"received" },
  ltMarkReq:  { es:"PEDIDA", en:"REQUESTED" },
  ltMarkRec:  { es:"LLEGÓ", en:"ARRIVED" },
  ltCopy:     { es:"COPIAR PETICIÓN", en:"COPY REQUEST" },
  ltCopied:   { es:"copiado ✓", en:"copied ✓" },
  ltDaysOpen: { es:"{n}d abierta", en:"{n}d open" },
  ltTook:     { es:"tardó {n}d", en:"took {n}d" },
  ltHistory:  { es:"RECIBIDAS", en:"RECEIVED" },
  ...
  // ─── reporte del miércoles ───
  mtgTitle:   { es:"⚑ DÓNDE DUELE HOY", en:"⚑ WHERE IT HURTS TODAY" },
  mtgLead:    { es:"Agrupado por fase, no por archivo. Cinco archivos repartidos en cinco etapas es mala suerte; cinco parados en la misma etapa es un cuello de botella con nombre.",
                en:"Grouped by phase, not by file. Five files spread across five stages is bad luck; five stuck in the same stage is a bottleneck with a name." },
  mtgNone:    { es:"Nada en rojo ni en ámbar. El pipeline está limpio hoy.",
                en:"Nothing red or amber. The pipeline is clean today." },
  mtgCrit:    { es:"{n} crítico(s)", en:"{n} critical" },
  mtgWarn:    { es:"{n} en aviso", en:"{n} warning" },
  mtgAll:     { es:"TODAS", en:"ALL" },
  mtgWaiting: { es:"se espera {w}", en:"waiting on {w}" },
  mtgOverCeil:{ es:"{d}d de {c}d", en:"{d}d of {c}d" },
  mtgWorst:   { es:"La mitad o más de lo que está en problemas vive en {p}. Eso no son {n} problemas, es uno.",
                en:"Half or more of what is in trouble lives in {p}. That is not {n} problems, it is one." },
