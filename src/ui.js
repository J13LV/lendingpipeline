...
export const UI = {
  ...
  legacyTypeHint:{ es:"Este tipo es de la época de PRMG. Escoge el producto real y describe la asistencia en el bloque de DPA.",
                   en:"This type is from the PRMG era. Pick the real product and describe the assistance in the DPA block." },
