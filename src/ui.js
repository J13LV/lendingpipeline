...
export const UI = {
  ...
  dpaProduct:{ es:"PRODUCTO", en:"PRODUCT" },
  dpaPctLabel:{ es:"PORCENTAJE", en:"PERCENTAGE" },
  dpaForm:{ es:"FORMA", en:"FORM" },
  dpaYears:{ es:"AÑOS PARA EL PERDÓN", en:"YEARS TO FORGIVENESS" },
  dpaIncomplete:{ es:"falta producto, porcentaje o forma", en:"missing product, percentage or form" },
  dpaBlockHint:{ es:"El lender ya está en el archivo. Estas casillas describen la asistencia, y con ellas se puede contar qué se vende más sin catalogar programa por programa.",
                 en:"The lender is already on the file. These boxes describe the assistance, and they let you count what sells most without cataloguing program by program." },
