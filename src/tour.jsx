...
export const DETAIL_STEPS = [
  ...
  { id: 17, tab: "lender", concept: true,
    en: "Broker has about 180 lenders; correspondent only 16. Pick correspondent and most of them disappear — the system tells you which ones were left out.",
    es: "En broker hay unos 180 lenders; en correspondent solo 16. Escoges correspondent y la mayoría desaparece — el sistema te dice cuáles quedaron fuera." },
...
export const PROCESSING_STEPS = [
  ...
  { id: 2, concept: true, field: "cola",
    es: "A la izquierda, la cola: manda el orden del día.",
    en: "On the left, the queue: it sets the order of the day." },
  { id: 3, concept: true, tab: "orders",
    es: "Y a la derecha, el archivo: aquí se trabaja el que escojas de la cola.",
    en: "And on the right, the file: this is where you work whichever one you pick from the queue." },
  { id: 4, concept: true, field: "cola",
  ...
  { id: 6, concept: true, field: "grupo-blocked",
  ...
  { id: 16, concept: true, field: "colas",
  ...
  { id: 24, tab: "findings", concept: true,
  ...
  { id: 30, tab: "checklist", roles: ["assistant", "admin"],
  ...
  { id: 33, concept: true, tab: "checklist",
